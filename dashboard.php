...
# Header section with company name and contact info
header = doc.add_paragraph()
header.alignment = WD_ALIGN_PARAGRAPH.CENTER
run = header.add_run("DreamCoders\n")
run.bold = True
run.font.size = Pt(16)
header.add_run("Email: contact@dreamcoders.ng | Phone: +234-XXX-XXX-XXXX\nAddress: Lagos, Nigeria\n\n").font.size = Pt(10)

# Document title
title = doc.add_paragraph()
title.alignment = WD_ALIGN_PARAGRAPH.CENTER
run = title.add_run("PROJECT EXPENSE PROPOSAL\n")
run.bold = True
run.font.size = Pt(14)
...
doc.add_paragraph(
    "Dear Client,\n\n"
    "This document outlines the proposed cost estimate for the development of an Android mobile application "
    "using Flutter. The app will help users locate the nearest available mechanic using real-time mapping and "
    "location services.\n"
)

# Function to add a table of expenses
def add_expense_table(title, expenses):
    ...
    for item, desc, cost in expenses:
        row_cells = table.add_row().cells
        row_cells[0].text = item
        row_cells[1].text = desc
        row_cells[2].text = cost

# Add all expense sections
add_expense_table("1. Development Costs", [
    ("Flutter App Development", "Coding the full app (UI + logic)", "₦150,000 – ₦300,000"),
    ("Backend Development", "Server setup, API development", "₦80,000 – ₦150,000"),
    ("Google Maps Integration", "Map, location services, routing", "₦20,000 – ₦40,000"),
    ("UI/UX Design", "App wireframes, design assets", "₦30,000 – ₦60,000"),
    ("Testing & Debugging", "Device testing, bug fixing", "₦15,000 – ₦30,000")
])

add_expense_table("2. Third-Party Services", [
    ("Firebase", "Authentication, DB (Free tier available)", "₦0 – ₦15,000/month"),
    ("Google Maps API", "Free for limited requests", "₦0 – ₦10,000/month"),
    ("Server Hosting", "For custom backends", "₦5,000 – ₦15,000/month")
])

add_expense_table("3. Publishing & Deployment", [
    ("Google Play Developer Fee", "One-time fee", "₦30,000 – ₦35,000"),
    ("App Assets", "Logo, Screenshots", "₦10,000 – ₦20,000"),
    ("Internet/Data Costs", "During development", "₦5,000 – ₦10,000")
])

add_expense_table("4. Optional Expenses", [
    ("Admin Panel", "To manage mechanics, users", "₦50,000 – ₦100,000"),
    ("SMS or Push Notifications", "Firebase or SMS APIs", "₦5,000 – ₦15,000/month"),
    ("Domain + Hosting", "Web backend", "₦10,000 – ₦20,000/year")
])

# Summary
doc.add_paragraph("\nTotal Initial Estimate: ₦400,000 – ₦780,000")
doc.add_paragraph("Monthly Operational Cost (if backend/server needed): ₦5,000 – ₦40,000")

# Terms & Notes
doc.add_paragraph("\nTerms & Notes", style='Heading 2')
doc.add_paragraph(
    "- Project timeline: 4–6 weeks\n"
    "- Payment: 60% upfront, 40% after delivery\n"
    "- Maintenance: Available on request\n"
    "- Proposal valid for 15 days from the date above\n"
)

# Closing
doc.add_paragraph(
    "We look forward to working with you on this exciting project. Please feel free to contact us for clarification or additional features.\n\n"
    "Sincerely,\n\n"
    "Muhammad Hassan Mohammed\n"
    "Lead Developer, DreamCoders"
)

# Save the document
file_path = "/mnt/data/DreamCoders_MechanicApp_Proposal.docx"
doc.save(file_path)
